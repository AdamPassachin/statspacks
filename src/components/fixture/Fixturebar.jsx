...
export default function Fixturebar({ time, homelogo, awaylogo, homeTeam, awayTeam, onClick}) {
  ...
  <div class="wrapper" onClick={onClick}>
    <a class="cta" href="#">
      ...
      <span>
        <svg width="35px" height="35px" viewBox="0 0 66 43" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
/*
  <>
    <button className='fixture-button-style'>
      <div className='row'>
        <div className='col-auto'>
          <p className='fixture-font'>{time}</p>
        </div>
